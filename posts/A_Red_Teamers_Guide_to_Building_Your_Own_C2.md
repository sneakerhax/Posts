...
One of the interesting aspects of C2 is that at first glance it seems complicated, but if you break it down to its core elements, it's really quite simple. I've learned this fact from building custom C2 and reading about C2 (a.k.a. malware) used by adversaries in the wild. Regardless of how it's used, the language or adversary group, C2 is usually always made up of the same core components.
